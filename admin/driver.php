			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2>
<?php
$result = mysqli_query($db,"SELECT * FROM driver");
...
$result= mysqli_query($db,"SELECT * from driver order by driverid DESC") or die (mysqli_error());
...
?>
					...
					?>
								<td class="center">
									...
									<a class="btn btn-danger" href="delete_driver.php<?php echo '?driverid='.$id; ?>">
