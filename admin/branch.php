...
<?php
$user_query  = mysqli_query($db,"SELECT * from admin where adminid = '$id_session'")or die(mysqli_error());
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2>
<?php
$result = mysqli_query($db,"SELECT * FROM branch order by branchid DESC");
...
$result= mysqli_query($db,"SELECT * from branch order by branchid DESC") or die (mysqli_error());
...
?>
					...
					?>
								<td class="center">
									...
									<a class="btn btn-danger" href="delete_branch.php<?php echo '?branchid='.$id; ?>">
