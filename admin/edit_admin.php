...
<?php
  $query=mysqli_query($db,"SELECT * from admin LEFT JOIN branch on admin.branchid = branch.branchid where adminid='$ID'")or die(mysqli_error());
$row=mysqli_fetch_array($query);
  ?>
				...
				$result =  mysqli_query("select * from branch")or die(mysqli_error()); 
...
$result=mysqli_query("select * from admin") or die (mysqli_error());
...
mysqli_query(" UPDATE admin SET branchid='$branchid', firstname='$firstname', lastname='$lastname', username='$username', password='$password', confirm_password='$confirm_password', 
user_type='$user_type'
