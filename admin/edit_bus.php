...
<?php
  $query=mysqli_query($db,"SELECT * from bus where busid='$ID'")or die(mysqli_error());
...
mysqli_query($db," UPDATE bus SET bus_number='$bus_number', bus_type='$bus_type' WHERE busid = '$id' ")or die(mysqli_error());
