...
<?php
$query=mysqli_query($db,"SELECT * from branch where branchid='$ID'")or die(mysqli_error());
...
mysqli_query($db," UPDATE branch SET branch_location='$branch_location' WHERE branchid = '$id' ")or die(mysqli_error());
