...
<?php
//$user_query  = mysqli_query("select * from admin where adminid = '$id_session'")or die(mysqli_error());
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<?php
								...
								$user_query=mysqli_query($db,"select *  from `admin` WHERE adminid='$id_session'");
