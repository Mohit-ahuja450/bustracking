			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2>
<?php
$result = mysqli_query($db,"SELECT * FROM bus");
...
<?php
include ('db/dbcon.php');
$result= mysqli_query($db,"select * from bus order by busid DESC") or die (mysqli_error());
...
?>
					...
					?>
								<td class="center">
									...
									<a class="btn btn-danger" href="delete_bus.php<?php echo '?busid='.$id; ?>">
