...
<?php
  $query=mysqli_query($db,"SELECT * from driver where driverid='$ID'")or die(mysqli_error());
...
mysqli_query($db," UPDATE driver SET firstname='$firstname', profile='$still_profile', lastname='$lastname', contact_number='$contact_number'
...
mysqli_query(" UPDATE driver SET firstname='$firstname', profile='$profile', lastname='$lastname', contact_number='$contact_number'
 WHERE driverid = '$id' ")or die(mysqli_error());
echo "<script>alert('Successfully Update Driver Info!'); window.location='driver.php'</script>";
}
}
